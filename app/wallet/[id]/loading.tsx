          ...
          <div className="grid grid-cols-1 gap-4 lg:col-span-2">
                ...
                <div className="bg-white p-6">
                  <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="mt-5 flex justify-center sm:mt-0">
                      <div className="flex items-center justify-center rounded-md bg-slate-300 px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 w-40 h-10 animate-pulse"></div>
                    </div>
                  </div>
                </div>
            ...
            <section aria-labelledby="quick-links-title">
              <div className="sm:grid-cols-1 overflow-hidden rounded-lg sm:grid sm:gap-4 sm:divide-y-0">
                ...
                >
                  <li
                    className={`ring-2 ring-inset ring-cyan-500 group  col-span-1 divide-y divide-gray-200 rounded-lg shadow bg-white focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500`}
                  >
                    <div className="group rounded-lg relative bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500">
                      <div className="inline-flex rounded-lg bg-slate-300 h-12 w-40 animate-pulse"></div>
                      <div className="mt-8">
                        <h3 className="text-lg font-medium">
                          <div className="focus:outline-none text-lg text-gray-900 bg-slate-300 h-4 w-28 rounded animate-pulse"></div>
                        </h3>
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <section aria-labelledby="announcements-title">
              <div className="overflow-hidden rounded-lg bg-slate-50 shadow">
                <div className="p-6">
                  <div className="bg-slate-300 h-3 w-32 animate-pulse rounded"></div>
                  <div className="mt-6 flow-root">
                    <ul
                      role="list"
                      className="-my-5 divide-y divide-gray-200 animate-pulse"
                    >
                      <li className="py-5">
                        <div className="relative focus-within:ring-2 focus-within:ring-cyan-500 h-24 bg-slate-300 w-full rounded"></div>
                      </li>
                      <li className="py-5">
                        <div className="relative focus-within:ring-2 focus-within:ring-cyan-500 h-24 bg-slate-300 w-full rounded"></div>
                      </li>
                  ...
                  <div className="mt-6">
                    <div className="flex animate-pulse items-center justify-center rounded-md bg-slate-300 w-full h-8 px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"></div>
                  </div>
                </div>
              </div>
            </section>
